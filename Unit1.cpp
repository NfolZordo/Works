...
HINSTANCE hDll; //ниже прототип будущей функции
...
Memo1->Lines->Add("Виконуєм BlockInput(true)...");
Result = BlockInput(true);
Memo1->Lines->Add("Result = " + FloatToStr(Result));
if(Result)
{
Memo1->Lines->Add("Тепер клиатура и миш доступні тільки, якщо нажать CTRL+ALT+DEL");
Memo1->Lines->Add("Ждем " + FloatToStr(tb) );
tb = tb*1000;
Sleep(tb);
}
